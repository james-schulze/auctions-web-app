...
//--AppNgine v.3.3
//---------------------------------------------------------------------------------------------------------------------------
//--AppNgine By Bravo Charlie http://www.google.com 
...
//--      d88b                                                      8888b     88                        ""                       
//--     d8'`8b                                                     88 `8b    88                                      
//--    d8'  `8b          8b,dPPYba,   8b,dPPYbp    88  `8b   88   ,adPPYb,d    88  8b,dPPYba,   ,adPPYba,
//--   d8YaaaaY8b    88P'      "8a   88P'    "8a    88   `8b  88  a8"    ` Y88   88  88P'   `"8a  a8P_____88
//--  d8""""""""8b     88         d8     88        d8    88    `8b 88  8b          88   88  88         88   8PP"""""""
//-- d8'        `    8b   88b,     ,a8"    88b,   ,a8"   88     `8888  "8a,    , d88   88  88         88   "8b,      ,aa
//--d8'          `    8b  88`YbbdP"'    88`YbbdP    88       `888  `"YbbdP"Y8   88  88         88     `"Ybbd8"'
//--                           88                  88                                      aa,       ,88                          
//--                           88                  88                                       "Y8bbdP"                           
//--
//--
...
class AppNgine {
    function __CONSTRUCT($aa) {
        ...
        $this->vrs =   array(
        					 ...
        					 array('pg'=>'1:2','sl'=>'','pd'=>'','vr'=>'d02_data_1_1_999_1_2_1','vl'=>'1','bg'=>'','vi'=>'false','rx'=>'','rt'=>'s'),
        					 ...
        					 array('pg'=>'1:3','sl'=>'','pd'=>'','vr'=>'d05_data_1_1_999_1_2_1','vl'=>'1','bg'=>'','vi'=>'false','rx'=>'','rt'=>'s'),
        					 array('pg'=>'1:4','sl'=>'','pd'=>'','vr'=>'d06_data_1_1_999_1_2_1','vl'=>'1','bg'=>'','vi'=>'false','rx'=>'','rt'=>'s'),
        					 array('pg'=>'1:5','sl'=>'','pd'=>'','vr'=>'d07_data_1_1_999_1_2_1','vl'=>'1','bg'=>'','vi'=>'false','rx'=>'','rt'=>'s'),
        					 array('pg'=>'4:1','sl'=>'','pd'=>'','vr'=>'d08_data_1_1_999_1_2_1','vl'=>'1','bg'=>'','vi'=>'false','rx'=>'','rt'=>'s'),
                ...
                if($this->vrs[$ai]['pg'] != $_SESSION['vu']) {
                	if($this->vrs[$ai]['sl'] != NULL) {
                		if($this->vrs[$ai]['sl'] != $_SESSION['seclvl']) {
		                    unset($_SESSION[$this->vrs[$ai]['vr']]);if(substr(get_class($this),7,1) != 'e') { return; }
		                    $this->ai++;
                		}
    ...
    private function create() {/*CREATES VARIABLES THAT EXIST ON A CERTAIN PAGE*/
    	for($ai=0;$ai<$this->aa;$ai++) {
    		if($this->vrs[$ai]['pg'] == '0' && !isset($_SESSION[$this->vrs[$ai]['vr']])) {
    			$_SESSION[$this->vrs[$ai]['vr']] = $this->vrs[$ai]['vl'];if(substr(get_class($this),5,1) != 'i') { return; }
    			$this->aii++;
    		}
    	}
    			...
    			if($this->vrs[$ai]['sl'] != NULL) {
    				if($this->vrs[$ai]['pd'] != NULL) {
    					if(isset($_SESSION['pd']) && $this->vrs[$ai]['pd'] == $_SESSION['pd']) {
    						if($this->vrs[$ai]['sl'] == $_SESSION['seclvl']) {
    							$_SESSION[$this->vrs[$ai]['vr']] = $this->vrs[$ai]['vl'];if(substr(get_class($this),1,1) != 'p') { return; }
    							$this->aii++;
    						}
    					}
    				} else {
    ...
    private function update() {/*UPDATES VARIABLES THAT EXIST ON A CERTAIN PAGE*/
        ...
        for($ai=0;$ai<$this->aa;$ai++) {
            if(($this->vrs[$ai]['pg'] == '0' && isset($_SESSION[$this->vrs[$ai]['vr']])) || ($this->vrs[$ai]['pg'] > '0' && $this->vrs[$ai]['pg'] == $_SESSION['vu'])) {
                if($this->vrs[$ai]['rt'] == 'g') {
                    if(substr(get_class($this),0,1) != 'A') { return; }
                    if($this->gvg == '1') {
                    ...
                    if(substr(get_class($this),2,1) != 'p') { return; }
                    if($this->gvp == '1') {
    ...
    private function mod5() {/*MODULE 5: CREATES DYNAMIC FORMS AND DATA LOOPS*/
    	...
    	if(count($arr1u) > '0') {
	    					...
	    					switch($arr3val['obj']) {
	    						...
	    						case 'd02':
	    							...
	    							*/
									...
									if($d02 == 15) {
										$this->upx('italian.bistro@aol.com','data_resource','write_code:13','italian.bistro@aol.com');
	    						...
	    						case 'd04':
	    							...
	    							if($d04 == 3) {
	    								...
	    								$this->upx('italian.bistro@aol.com',$_SESSION['d04_bname_1_1_109_2_1_1'],$_SESSION['d04_descr_3_1_203_6_1_1'],$_SESSION['d04_email_2_1_202_2_1_1']);
	    						...
	    						break;
	    						case 'd05':
	    							echo('<span class="c_ffffff"><h3>#Buy Weed Online</h3></span>');

									echo('<img src="./www-img/droWeedMart1tmb.jpg">');

									echo('<span class="c_ffffff"><em>#WeedAuctions!</em>&nbsp;<em>#WeedChat!</em><br><em>#OrderOnline!</em><br><em><span id="InquireToday" style="color:#FFFF00;">#ChatBuyPickupLocal!</span></em></span>');
	    						break;
	    						case 'd06':
	    						...
	    						break;
								case 'd07':
									echo('<span class="c_ffffff"><h5>#Chat</h5>');
									
									echo('</span>');
								break;
								case 'd08':
	    							$ai = '<img src="./www-img/vipNotSiri.png" style="padding: 0px 2px 0px 0px;float: left;">@Ciri Says::&#160;';
	    							switch($_SESSION['d08_data_1_1_999_1_2_1']) {
	    								case '1':
	    									$this->dbq('1',$ai.'<span id="status">"Would you like to smoke some weed?"</span>');
	    									if($_SESSION['dbq'] == '1') {
	    										$_SESSION['dbq'] = '0';
    		...
    		if(substr(get_class($this),4,1) != 'g') { return; }
    	}
    }
...
$tme = microtime();
$app = new AppNgine($tme);
echo('<!--'.strtoupper($www).' BY AppNgine-->');
?>
